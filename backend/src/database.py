...
from src.config import MONGO_URI, DB_NAME, USERINFO_COLLECTION, MEDICAL_COLLECTION, GOOGLE_CALENDAR_COLLECTION, PATIENT_KEY_COLLECTION, GMAIL_COLLECTION, PATIENT_DATA_COLLECTION, PATIENT_DIARY_COLLECTION
