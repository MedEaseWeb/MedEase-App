...
/** Section nav shared with QuestionsInTheLoop: User Survey | Home | Community | Notes */
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Plan medical routines and review your care summaries in one place.
        </Typography>
        ...
        >
          <Tab
            ...
            label="Schedule"
          />
          <Tab icon={<ChatIcon />} iconPosition="start" label="Chat Records" />
        </Tabs>
