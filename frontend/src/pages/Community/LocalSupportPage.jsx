...
export default function LocalSupportPage() {
  ...
  const filterLabels = t("community.localSupport.filters", { returnObjects: true });
  const FILTERS = [
    { id: "all", label: filterLabels[0] },
    { id: "free", label: filterLabels[1] },
    { id: "emory", label: filterLabels[2] },
    { id: "atlanta", label: filterLabels[3] },
    { id: "paid", label: filterLabels[4] },
  ];
  ...
  return (
    <CommunityLayout
      title={t("community.localSupport.title")}
      subtitle={t("community.localSupport.subtitle")}
    >
        ...
        {filtered.map((r) => (
          <Grid item xs={12} sm={6} md={4} key={r.id}>
            ...
            >
              ...
              >
                {t("community.localSupport.contact")}
              </Button>
            </Paper>
          </Grid>
        ))}
        ...
        {detail && (
          <>
            ...
            <DialogActions sx={{ px: 3, pb: 2 }}>
              ...
              >
                {t("community.localSupport.visitSite")}
              </Button>
            </DialogActions>
          </>
        )}
