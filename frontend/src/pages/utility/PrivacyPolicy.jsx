  ...
  <div data-custom-class="body">
        ...
        <strong>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="subtitle">
              Last updated <bdt className="question">April 16, 2025</bdt>
            </span>
          </span>
        </strong>
      </span>
    ...
    <div>
      ...
      <ul>
        <li data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15 }}>
            Use <bdt className="question">MedEase</bdt>.{" "}
            <bdt className="question">
              MedEase is an AI-powered health companion designed to help
              patients better understand their medical information. Our platform
              uses advanced natural language processing and large language
              models to simplify complex medical reports, offer personalized
              medication guidance, and support caregiver coordination. By
              transforming dense clinical language into clear, actionable
              insights, MedEase empowers patients—especially students,
              non-native speakers, and underserved communities—to take charge of
              their healthcare with confidence.
            </bdt>
          </span>
          <bdt className="statement-end-if-in-editor">
            <span style={{ fontSize: 15 }} />
      ...
      <div style={{ lineHeight: "1.5" }}>
        ...
        <a
          ...
          href="https://app.termly.io/notify/66a1b7c7-e607-45b2-9446-ff0fe12e51ce"
      ...
      <ul>
        <li data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="body_text">
              <bdt className="question">genetic data</bdt>
            </span>
          </span>
        </li>
      </ul>
                                                  ...
                                                  <ul>
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                        ...
                                                        <span data-custom-class="body_text">
                                                          <bdt className="block-component" />{" "}
                                                          We use certain Google
                                                          Maps Platform APIs to
                                                          retrieve certain
                                                      ...
                                                      >
                                                        <span data-custom-class="body_text">
                                                          ...
                                                          <bdt className="block-component" />{" "}
                                                          The Google Maps
                                                          Platform APIs that we
                                                          use store and access
                                                          cookies and other
                                                          information on your
                                                          devices. If you are a
                                                          user currently in the
                                                          European Economic Area
                                                          (EU countries,
                                                          Iceland,
                                                          Liechtenstein, and
                                                          Norway) or the United
                                                          Kingdom, please take a
                                                          look at our Cookie
                                                          Notice
                                                          <bdt className="block-component" />
                                                          .
