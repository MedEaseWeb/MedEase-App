...
const TermsOfService = () => {
  ...
  <div data-custom-class="body">
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <span style={{ color: "rgb(0, 58, 250)" }}>
            <bdt className="question">
              <a
                href="https://medease.pages.dev/login"
                target="_blank"
                data-custom-class="link"
              >
                https://medease.pages.dev/login
              </a>
            </bdt>
          </span>{" "}
      ...
      >
        <bdt className="question">
          MedEase is an AI-powered health companion designed to help patients
          better understand their medical information. Our platform uses
          advanced natural language processing and large language models to
          simplify complex medical reports, offer personalized medication
          guidance, and support caregiver coordination. By transforming dense
          clinical language into clear, actionable insights, MedEase empowers
          patients—especially students, non-native speakers, and underserved
          communities—to take charge of their healthcare with confidence.
        </bdt>
      </div>
      <div
        className="MsoNormal"
      ...
      >
        ...
        >
          ...
          <bdt className="block-component">
            email at <bdt className="question">medease@gmail.com</bdt>
      ...
      >
        ...
        >
          ...
          <bdt className="statement-end-if-in-editor" />
          ), and <bdt className="question">MedEase</bdt>, concerning your access
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <a data-custom-class="link" href="#sitemanage">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
            <span data-custom-class="body_text">8. SERVICES MANAGEMENT</span>
          </span>
        </a>{" "}
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <a data-custom-class="link" href="#terms">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
            <span data-custom-class="body_text">10. TERM AND TERMINATION</span>
          </span>
        </a>{" "}
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <a data-custom-class="link" href="#disputes">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
            <span data-custom-class="body_text">13. DISPUTE RESOLUTION</span>
          </span>
        </a>{" "}
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question">medease@gmail.com</bdt>. If we ever grant
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          <bdt className="block-component" />{" "}
          <bdt className="question">Dekalb</bdt>,
          <bdt className="statement-end-if-in-editor" />{" "}
          <bdt className="block-component" />
        ...
        <strong>
          ...
          >
            <strong>
              <bdt className="question">
                <bdt className="block-component" />
                <bdt className="question">medease@gmail.com</bdt>
                <bdt className="statement-end-if-in-editor" />
              </bdt>
            </strong>
          </span>
