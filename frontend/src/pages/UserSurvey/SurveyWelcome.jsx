...
export default function SurveyWelcome() {
  ...
  const points = [
    ...
    "Always seek a qualified healthcare provider for urgent or serious concerns.",
    "We cannot assume liability for decisions made based on this survey.",
  ];
    ...
    <SurveyShell>
      <Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
        <Box>
          ...
          >
            We’re here as your companion to help you navigate your recovery
            journey.
          </Typography>
        </Box>
